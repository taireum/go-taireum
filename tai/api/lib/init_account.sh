geth="/opt/go-taireum/build/bin/geth"
rm -rf $1/geth
rm -rf $1/keystore
mkdir -p $1
...
sleep 2;
\cp passwd /opt
echo "$geth  --nodiscover --datadir $1 --mine --unlock \"0x$address\" --password /opt/passwd --etherbase   \"0x$address\"  --rpc  --rpcport $3 --rpcapi=\"api,miner,db,eth,net,web3,personal,admin\"  --networkid $5 ">/opt/master.sh
